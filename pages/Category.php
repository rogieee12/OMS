...
<head>
  ...
  <title>IPMS | Evaluation Category</title>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/SchoolYear.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>School Year</p>
                </a>
              </li>             
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                     <?php 
                        $q=mysqli_query($connection,"SELECT * FROM quescategory");
                    ...
                    <td><button class="btn btn-primary edit" value="<?php echo $rows[0]; ?>" >EDIT</button>
                      ...
                      <button class="btn btn-danger delete" value="<?php echo $rows[0]; ?>" >DELELTE</button></td>  
                  </tr>
                   <?php  
                   }
                   ?>
...
$(document).ready(function(){
  ...
  $(".edit").click(function(e){
      ...
      $.ajax({
            type:'POST',
            url: '../Actions/Category/Get.php',
            data: {id:id},
            dataType: 'json',
            success: function(data){
                $("#Cat").val(data.Category);
                $("#p_id").val(data.qcat_id);
