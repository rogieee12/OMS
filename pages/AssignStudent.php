        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="ClassToAnnounce.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Announcement</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assign Students to OJT Supervisor</h1>
          </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                   <button type="button" class="btn  btn-success btn-sm" id="add" data-toggle="modal" data-target="#modal-default">NEW SUPERVISOR</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-sm btn-primary" href="StudentsForSupervisor.php?a=<?php echo $rows[0];?>">ASSIGN STUDENT</a>
                      <a class="btn btn-sm btn-warning" href="ClassList.php?a=<?php echo $rows[0];?>">VIEW LIST</a>
                      <button class="btn btn-sm btn-danger delete" value="<?php echo $rows[0]; ?>" >DELETE</button>
                    </td>
                  </tr>
                   <?php  
                   }
