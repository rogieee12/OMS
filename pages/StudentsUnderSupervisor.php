  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../coordinatorindex.php" class="nav-link">Home</a>
      </li>
    </ul>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                     <?php 
                        $q=mysqli_query($connection,"SELECT studentlist.student,CONCAT(firstname,' ',lastname) as Fullname FROM studentlist INNER JOIN accounts ON studentlist.student=accounts.username WHERE studentlist.supervisor='".$_SESSION['u']."'");
                        while($rows=mysqli_fetch_array($q)){
                      ?>
                  <tr>
                    <td><?php echo $rows[1]; ?></td>  
                    <td>
                      <a class="btn btn-warning btn-sm evaluate" href="evaluate.php?a=<?php echo $rows[0]; ?>" >EVALUATE</a>
                    </td>
                  </tr>
                   <?php  
                   }
